...
class Client(Base):
    ...
    updated_date = Column(DateTime, nullable=True, onupdate=lambda: datetime.now(timezone.utc))
    ...
    users = relationship("User", secondary="users_has_clients", back_populates="clients")
