...
CREATE TABLE IF NOT EXISTS `Epic_events_database`.`contracts` (
  ...
  `contract_satement_id` INT NOT NULL,
  `clients_id` INT NOT NULL,
  `created_at` DATETIME NOT NULL,
  `updated_at` DATETIME NULL,
  `deleted_at` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_contracts_contract_satement1_idx` (`contract_satement_id` ASC) VISIBLE,
  INDEX `fk_contracts_clients1_idx` (`clients_id` ASC) VISIBLE,
  CONSTRAINT `fk_contracts_contract_satement1`
    FOREIGN KEY (`contract_satement_id`)
...
CREATE TABLE IF NOT EXISTS `Epic_events_database`.`departements_has_permissions` (
  ...
  INDEX `fk_departements_has_permissions_departements1_idx` (`departements_id` ASC) VISIBLE,
