...
CREATE TABLE IF NOT EXISTS `Epic_events_database`.`contracts` (
  ...
  `deleted_at` DATETIME NULL,
  `users_id` INT NULL,
  `payed_amount` DECIMAL(7,2) NOT NULL,
  PRIMARY KEY (`id`),
  ...
  INDEX `fk_contracts_users1_idx` (`users_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Epic_events_database`.`events` (
  ...
  INDEX `fk_events_contracts1_idx` (`contracts_id` ASC) VISIBLE,
